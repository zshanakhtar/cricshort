    ...
    <table className="min-w-full text-sm">
      <thead>
        <tr className="bg-blue-50">
          ...
          <th className="px-3 py-2 text-xs font-bold text-blue-700">L</th>
          <th className="px-3 py-2 text-xs font-bold text-blue-700">NR</th>
          <th className="px-3 py-2 text-xs font-bold text-blue-700">Pts</th>
          <th className="px-3 py-2 text-xs font-bold text-blue-700">NRR</th>
          <th className="px-3 py-2 text-xs font-bold text-blue-700">Form</th>
        </tr>
      </thead>
      <tbody>
